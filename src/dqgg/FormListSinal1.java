 ...
 * @author AntonioSousa
 */
public class FormListSinal1 extends javax.swing.JFrame {
    ...
    public FormListSinal1() {
        ...
        JTable rowTable = new RowNumberTable(tbListaSinais);
        this.jScrollPane1.setRowHeaderView(rowTable);
        this.jScrollPane1.setCorner(JScrollPane.UPPER_LEFT_CORNER,
        rowTable.getTableHeader());
        
        final FormListSinal1 formLista = this;
                                            ...
                                            public void mouseClicked(MouseEvent e){  
                                              if(e.getClickCount() == 2){  
                                                // abre o formulário com os dados do Sinal atual
                                                 int linhaSelecionada = tbListaSinais.getSelectedRow();                                                  
                                                // comentado apenas para evitar erros de compilaçao - descomentar se for utilizar
    ...
    private void initComponents() {
        ...
        jScrollPane1.setPreferredSize(new java.awt.Dimension(620, 545));
        ...
        tbListaSinais.setAlignmentX(1.0F);
        tbListaSinais.setAlignmentY(1.0F);
        tbListaSinais.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_NEXT_COLUMN);
        tbListaSinais.setColumnSelectionAllowed(true);
        tbListaSinais.setMaximumSize(new java.awt.Dimension(5000, 5000));
        tbListaSinais.setRowHeight(20);
        jScrollPane1.setViewportView(tbListaSinais);

        TabBuscaAlfa.add(jScrollPane1);
        ...
        btIrPara.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btIrParaMouseClicked(evt);
            }
        });
    ...
    private void btIrParaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btIrParaMouseClicked
    ...
    }//GEN-LAST:event_btIrParaMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormListSinal1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormListSinal1().setVisible(true);
            }
        });
    }
